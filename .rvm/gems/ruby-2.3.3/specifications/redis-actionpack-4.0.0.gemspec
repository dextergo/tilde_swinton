...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<redis-rack>.freeze, ["~> 1.5.0"])
      ...
      s.add_development_dependency(%q<mini_backtrace>.freeze, [">= 0"])
    else
      s.add_dependency(%q<redis-store>.freeze, ["~> 1.1.0"])
      s.add_dependency(%q<redis-rack>.freeze, ["~> 1.5.0"])
      ...
      s.add_dependency(%q<mini_backtrace>.freeze, [">= 0"])
    end
  else
    s.add_dependency(%q<redis-store>.freeze, ["~> 1.1.0"])
    s.add_dependency(%q<redis-rack>.freeze, ["~> 1.5.0"])
