...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<haml>.freeze, ["< 5.0", ">= 3.1"])
      ...
      s.add_development_dependency(%q<appraisal>.freeze, [">= 0.3.8"])
    else
      s.add_dependency(%q<haml>.freeze, ["< 5.0", ">= 3.1"])
      ...
      s.add_dependency(%q<appraisal>.freeze, [">= 0.3.8"])
    end
  else
    s.add_dependency(%q<haml>.freeze, ["< 5.0", ">= 3.1"])
    s.add_dependency(%q<activesupport>.freeze, [">= 4.0.1"])
