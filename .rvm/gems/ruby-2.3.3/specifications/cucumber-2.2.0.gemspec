...
Gem::Specification.new do |s|
  ...
  s.summary = "cucumber-2.2.0".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<cucumber-core>.freeze, ["~> 1.3.0"])
      s.add_runtime_dependency(%q<builder>.freeze, [">= 2.1.2"])
      s.add_runtime_dependency(%q<diff-lcs>.freeze, [">= 1.1.3"])
      s.add_runtime_dependency(%q<gherkin3>.freeze, ["~> 3.1.0"])
      ...
      s.add_runtime_dependency(%q<event-bus>.freeze, ["~> 0.1.0"])
      ...
      s.add_dependency(%q<cucumber-core>.freeze, ["~> 1.3.0"])
      s.add_dependency(%q<builder>.freeze, [">= 2.1.2"])
      s.add_dependency(%q<diff-lcs>.freeze, [">= 1.1.3"])
      s.add_dependency(%q<gherkin3>.freeze, ["~> 3.1.0"])
      ...
      s.add_dependency(%q<event-bus>.freeze, ["~> 0.1.0"])
