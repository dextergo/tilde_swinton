...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<http>.freeze, [">= 0.5.0"])
      ...
      s.add_development_dependency(%q<excon>.freeze, ["< 0.30.0", ">= 0.27.5"])
      ...
      s.add_dependency(%q<excon>.freeze, ["< 0.30.0", ">= 0.27.5"])
